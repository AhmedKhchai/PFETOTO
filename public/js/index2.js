...
/* Chart-js (#lineChart1) */
	...
	gradientStroke1.addColorStop(0, 'rgba(0, 20, 142 ,0.3)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgba(255, 136, 25,0.3)');
	...
	gradientStroke1.addColorStop(0, 'rgba(0, 20, 142 ,0.8)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 300);
	gradientStroke2.addColorStop(0, 'rgba(255, 136, 25,0.8)');
	var myChart = new Chart(myCanvas, {
		type: 'bar',
		data: {
