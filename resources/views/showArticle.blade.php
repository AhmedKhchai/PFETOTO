    ...
    <section class="sptb">
                            ...
                            <div class="item-card item-card-square overflow-hidden br-0">
                                <div class="item-card-desc">
                                    ...
                                    <div class="card text-center overflow-hidden mb-md-0 br-0">
                                        <div class="card-img">
                                            <img src="{{ $article->image }}" alt="img" class="cover-image br-0">
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <h6 class="font-weight-normal"><span><i
                                                                    ...
                                                                    class="text-body">{{ $article->adresse }}</a></h6>
                                                            <h6 class="font-weight-normal"><span><i
                                    ...
                                    <div class="item-card7-text">
                                        <ul class="icon-card mb-0 mt-2">
                                            <li><a href="#" class="icons"><i
                                                    ...
                                                    Jadida</a></li>
                                            <li><a href="#" class="icons"><i class="icon icon-event text-muted mr-1"></i> 2
                                                    hours ago</a>
                                            </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="item-card7-text">
                                        <ul class="icon-card mb-0 mt-2">
                                            ...
                                            <li><a href="#" class="icons"><i class="icon icon-event text-muted mr-1"></i> 5
                                                    hours ago</a>
                                            </li>
                                            <li class="mb-0"><a href="#" class="icons"><i
        ...
        @csrf
					...
					<div class="card mb-lg-0">
						...
						@auth
                            <div class="card-body">
							<p class="mb-0">Ajouter votre note pour ce service</p>
							<div class="rating-stars mb-4 mt-0 d-flex">
								<input type="number" readonly="readonly" class="rating-value star"
									name="rating-stars-value" value="2">
								<div class="rating-stars-container mr-2">
							...
							<div class="mt-2">
								...
								<div class="form-group">
									<textarea class="form-control" rows="6"
										placeholder="Votre Commentaire" name="comment"></textarea>
								</div>
								<button type="submit" class=" container btn btn-secondary btn-lg btn-block "
            style="margin-bottom: 2rem">Envoyer Commentaire</button>
							</div>
						</div>
                        @endauth
					</div>
						</form> --}}
                    @livewire('article-ratings', ['article' => $article], key($article->id))
                </div>
                        ...
                        <div class="tab-content border-0 bg-white">
                            <div class="tab-pane active" id="tab-contact">
                                <div class="card-body item-user">
                                    ...
                                    <div>
                                        <h6><span class="font-weight-semibold"><i class="fa fa-map mr-3 mb-2"></i></span><a
                                                href="#" class="text-body">Km 10, Route de Casablanca، El Jadida 24000
                                            </a></h6>
