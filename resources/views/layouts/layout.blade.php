                    ...
                    <div class="col-xl-5 col-lg-5 col-sm-8 col-5">
                        <div class="top-bar-right">
                            <ul class="custom ">
                                ...
                                <li>
                                    <a href="login.html" class="text-dark"><i class="fa fa-sign-in mr-1"></i>
                                        <span>S'identifier</span></a>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="text-dark" data-toggle="dropdown"><i
                                            class="fa fa-home mr-1"></i><span> Tableau de Bord</span></a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <a href="mydash.html" class="dropdown-item">
                                            <i class="dropdown-icon icon icon-user"></i> Mon Profile
                                        </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-12">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li><a href="resto-list.html"><i
                                            class="fa fa-angle-double-right mr-2 text-secondary"></i>
                                        Restaurant</a></li>
                                <li><a href="cafe-list.html"><i
                                            class="fa fa-angle-double-right mr-2 text-secondary"></i>
                                        Café</a></li>
                                <li><a href="hotel-list.html"><i
                                            class="fa fa-angle-double-right mr-2 text-secondary"></i>
                                        Hotels</a></li>
                            </ul>
                        </div>
                        <div class="col-xl-3 col-lg-6 col-md-12">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="contact.html"><i class="fa fa-home mr-3 text-secondary"></i> El jadida</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="contact.html"><i class="fa fa-phone mr-3 text-secondary"></i>+212 638 10 80
                                        46</a>
                                </li>
                            </ul>
                        </div>
